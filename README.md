...
- حالة اللعبة والترحيل الآمن للحالات القديمة والتراجع: `assets/js/core/state.js`
- التخزين المحلي ومزامنة أحدث نسخة محفوظة: `assets/js/core/storage.js`
...
يفحص `check:semantic` الاتساق بين نموذج السلطة والأسئلة، ومسارات العمل وعدم العمل، وتفسير الحقوق، وترحيل الحالة، واتساق نمط المهام، وبنية الاعتراض والاستنتاج؛ أي أنه يختبر المعنى بين المكونات لا سلامة الصياغة البرمجية فقط.
