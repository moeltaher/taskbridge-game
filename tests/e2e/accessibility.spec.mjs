...
test('data work market and accessible semantic task have no WCAG A/AA axe violations',async({page},testInfo)=>{
  ...
  // Native mobile Safari controls do not expose desktop-style keyboard focus
  // consistently. Keep the keyboard-focus assertion on desktop projects while
  // still validating the control's accessibility and operability on mobile.
