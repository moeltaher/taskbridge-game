...
assert.ok(workflow.includes('node scripts/generate-pages.mjs --check')&&workflow.includes('node scripts/structural-check.mjs')&&workflow.includes('node scripts/check.mjs')&&workflow.includes('node scripts/domain-check.mjs')&&workflow.includes('node --check'));
