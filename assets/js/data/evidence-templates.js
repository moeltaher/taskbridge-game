export const evidenceTemplates={
 ...
 allocation:{title:'ترتيب الوصول للمهام',dimension:'allocation',preferredKind:'ctrl',validKinds:['ctrl','dep'],text:'توزيع فرص العمل يعكس سلطة على الوصول؛ قد تكون هذه السلطة للمنصة أو موزعة بينها وبين العميل بحسب السيناريو.'},
 opacity:{title:'منطق ترتيب غير شفاف',dimension:'allocation',preferredKind:'ctrl',validKinds:['ctrl'],text:'المنصة تعرض مؤشرات عامة دون كشف وزن كل مؤشر في ترتيب الحساب.'},
