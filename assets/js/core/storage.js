...
export function archiveResult(x){const a=JSON.parse(localStorage.getItem(RESULTS_KEY)||'[]');a.push(x);localStorage.setItem(RESULTS_KEY,JSON.stringify(a.slice(-30)))}
