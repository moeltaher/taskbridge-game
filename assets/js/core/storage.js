...
function allResults(){return mergeArrays(readFrom(local(),LEGACY_RESULTS_KEY,[]),readFrom(session(),LEGACY_RESULTS_KEY,[]),readFrom(local(),RESULTS_KEY,[]),readFrom(session(),RESULTS_KEY,[]))}
