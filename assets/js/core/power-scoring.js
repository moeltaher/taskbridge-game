...
export function powerAxisCredit(values,target){const leaderCredit=jaccard(leaders(values),leaders(target)),groupCredit=jaccard(topGroup(values,2),topGroup(target,2));return .65*leaderCredit+.35*groupCredit}
